...
~SmileResponse()
    Haha, that may be true, but the time we spent apart felt far longer than that.
    **[Oh, poetic]
    ~HappyResponse()
    That may be, but that doesn't mean that it's any less true. It's been a while since I found myself genuinly intrigued by another person. 
      ***[Oh? Should I count myself lucky then?]
          ~SmileResponse()
         I believe I'm the lucky one in this scenario, after all, you did agree to a second date with me. In my apartment nonetheless.
         ****[Yeah, you are the lucky one.]
             ...
             ******[Not really, I kept having nightmares...]
                     ~EmbarrassedResponse()
                      Hmm, that's unfortunate to hear, Maybe it's bad airflow? You could try sleeping here and see if things imporve, I do have a lot of plants. ->Plants
              ******[What message?]
                   ~AnnoyedResponse() 
                   Uhm, The message that held the details to todays date? This date? Maybe I did mess up your sleep schedule...->Plants
             ...
             ******[Not really, I kept having nightmares...]
                     ~EmbarrassedResponse()
                      Hmm, that's unfortunate to hear, maybe it's bad airflow? You could try sleeping here and see if things improve, I do have a lot of plants. ->Plants
              ******[What message?]
                   ~AnnoyedResponse() 
                   Uhm, the message that held the details to todays date? This date? Maybe I did mess up your sleep schedule...->Plants
      ...
      ****[That's a bad excuse]
       ...
       ****[Caught off guard?]
       ~EmbarrassedResponse() 
       The fact that I'm nonbinary is usually enough to put people off from dating me. So of course I'd be suprised when a pretty face like yours decides I'm worth a shot.
       *****[Maybe I think you're pretty too]
             ...
             ******[Not really, I kept having nightmares...]
              ...
              ******[What message?]
                   ~AnnoyedResponse() 
                   Uhm, the message that held the details to todays date? This date? Maybe I did mess upp your sleep schedule...->Plants
    ...
    **[Not the response I was expecting]
    ~NeutralResponse()
    Apologies, I simply meant that I'm happy to see you again, maybe I got a bit excited. It has been a while since I found myself genuinly intrigued by another person. 
     ***[Oh? Should I count myself lucky then?]
          ~SmileResponse()
         I believe I'm the lucky one in this scenario, after all, you did agree to a second date with me. In my apartment nonetheless.
         ****[Guess were both lucky then]
             ...
             *****[Not really, I kept having nightmares...]
                     ~EmbarrassedResponse()
                      Hmm, Thats unfortunate to hear, Maybe it's bad airflow? You could try sleeping here and see if things improve, I do have a lot of plants. ->Plants
              *****[What message?]
                   ~AnnoyedResponse() 
                   Uhm, The message that held the details to todays date? This date? Maybe I did mess upp your sleep schedule...->Plants
         ****[It's not like I had a choice]
...
~EmbarrassedResponse()
I missed you too, it seems you really did manage to leave a lasting impression on me. Not many manage to do that these days.
 ***[Oh? Should I count myself lucky then]
          ~SmileResponse()
         I believe I'm the lucky one in this scenario, after all, you did agree to a second date with me. In my apartment nonetheless.
         ****[Yeah, you are the lucky one]
  ...
  *[There are a lot of plants...]
  Ah, still? Hmm, I even took the time to store some of them elsewhere but it seems it might have been all for naught. 
    **[This is...not all of the plants?]
     ~SmileResponse() 
     Im afraid not, I have managed to accumulate quite a collection these past years. I even cultivated them myself.
          ***[I don't really care...]
       ~AnnoyedResponse() 
       ...Alright then.Oh, ->Drink
     ***[Oh you did?]
           ~HappyResponse()
            Yup, I did. It took quite and extensive amount of researching to make sure that all of the plants have the correct amount of sunlight, that they got the water needed and that the...Ah, It seems I may be rambling. 
        ****[I don't mind]
        ~SmileResponse()
        That's good to know, But right now I would like to give my full attention to you, rather than my houseplants. 
          *****[your'e right, Im way more interesting than a plant]
          ~SmileResponse()
          ...
          *****[What If I like hearing you rant about plants?]
          ~HappyResponse()
           I will keep it in mind, but I would also get to know you during our time togther. I will indulge in providing more plant information at another time.
              ******[Another time then]
                -->Drink
              ******[Aw, But I want to learn about plants]
               ~HappyResponse()
                Haha, ok, if you insist. Is there any type in particular you would like more info about.
                  *******[The green one]
                 That one is one of my favorites. Not only does it have long luscious leaves, But when it's flowers bloom it let out an aroma almost as sweet as you.  --> Drink
                  *******[I changed my mind]
                    Oh? Maybe another time then. --> Drink
                  *******[Suprise me!] 
                   Did you know that the queen of night, a cactus, have gorgeous white flowers that only bloom once a year? The flowers lifespan is also short, as they will have withered away the following morning.
                   ********[Kinda boring]
                    ~NeutralResponse()
                    ...
                    ********[That sounds so cool]
                     ~SmileResponse()
                      It really is an experience, if you are interested I could invite you over again when they are due to bloom?
                    *********[I'd like that]
                    ~HappyResponse()
    ...
    **[Maybe you should get rid of some plants?]
    ~AnnoyedResponse()
    I'm quite proud of my collection actually, not only does it consist of a variety of species, but I cultivated each and everyone by myself.
       ***[Oh you did?]
           ~HappyResponse()
            Yup, I did. It took quite and extensive amount of researching  to make sure that all of the plants have the correct amount of sunlight, that they got the water needed and that the...Ah, It seems I may be rambling. 
        ****[I don't mind]
        ~SmileResponse()
        That's good to know, But right now I would like to give my full attention to you, rather than my houseplants. 
          *****[You're right, Im way more interesting than a plant]
          ~SmileResponse()
         Even if I dedicated the rest of my life to botany, I doubt anything would even come close to you~ --> Drink
          *****[What If I like hearing you rant about plants?]
          ~HappyResponse()
    ...
    **[Botany?]
    ~HappyResponse()
    It's a branch in Biology that focuses on the scientific study of plants. This includes their physiology, structure, genetics, ecology...Apologies, It seems I may be rambling. 
        ***[Yeah...]
        ~NeutralResponse()
        Apologies, I sometimes do..
        ***[I don't mind]
        ~SmileResponse()
        That's good to know, But right now I would like to give my full attention to you, rather than my houseplants. 
          ****[You're right, Im way more interesting than a plant]
                ...
                Haha, ok, if you insist. Is there any type in particular you would like more info about?
                  ...
                  ******[Suprise me!] 
                   ...
                   *******[Kinda boring]
                    ...
                    ********[I think I'll pass]
                    ~NeutralResponse()
                    That's also fine, I guess.. -> Drink
        ****[Yeah, Kinda]
              ...->Drink
==Green==
  You are not the first to mention that. It's always been my favourite colour, and then when I started microbiology and took an interest in botany... It sort of just took over.
    **[Maybe you should get rid of some plants?]
    ~AnnoyedResponse()
...
==Drink
How rude of me, I got so absorbed in our conversation I forgot to ask, would you like something to drink? I've worked out a way to brew some of my plants into something akin to tea! 
*[Ooh, sound nice]
Yes, I've been experimenting with different tastes and trying to find the perfect combination. Oh, and that's why I needed that book from the store, I usually just borrow them from the library otherwise. 
**[Ah I see. That's why you needed the book]
...
Oh simply that some of the plants have a very strong flavour. If not mixed correctly it will come out tasting less like a brew and more like I just shoved leaves down your throat. 
****[That makes sense]  
