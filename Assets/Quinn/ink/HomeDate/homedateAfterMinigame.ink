 ...
 *[I looked around your room a bit]
  ...
  *[Basil?]
     ...
     **[What kind of name is Basil..?]
          ...
          ***[Still a weird name]
              ~AnnoyedResponse() 
              Maybe, but weird does not always have to mean bad. Oh, since you say you didn't look around that much, would you like me to give you a brief tour of some of the things I have?
                   ****[Yeah, That would be nice]
                     ~HappyResponse()
                      What would you like to know more about? ->Items
                ****[Not really]
 ...
 *[ Microscope]
  ~AnnoyedResponse()
  Ah, I would prefer if you refrained from touching that, simply because it is quite a complex piece of equipment.
   **[You think I'm too stupid to understand it?]
   ~AnnoyedResponse()
     ...
     ***[And what if i did mess with the settings?]
         ...
         ****[You are the one who left me alone]
             ~AnnoyedResponse()
              ...
              ~NegativeResponse() 
              See my reaction? Where you really so bored in the 5 minutes I left that you felt the need to aggrevate me?
         ...
         ****[I didn't actually mess with it]
              ...
              *****[I thought it would be funny]
                    ~AnnoyedResponse() 
                    You thought it would be funny to say that you purposefully messed with and potentially destroyed my stuff? -> Arguing
   **[I was being careful...]
    ~NeutralResponse() 
     I suppose I should have put it away if I didn't want you to touch it. 
     ***[So no harm done?]
         ~HappyResponse()
         No, luckily not. If you are that interested in it I could teach you how to use it sometime?
    ****[Not really]
         ~NeutralResponse()
         That's understandable, it's not for everyone. ->toughConvo
     ****[That would be nice]
          ~EmbarrassedResponse()
          Then I look forward to having someone like you as my student. I feel like I should warn you that I can get quite absorbed in the subject, so feel free to cut off my rambles. 
 ...
 *[The Smiths poster ]
   ~NeutralResponse() 
    Oh, You also like The Smiths? I think their music has a sort of passion that is hard to come by these days. 
     **[Yeah, I really like rock]
       ~HappyResponse()
        Me too, it really does wonders for soothing the soul on a bad day. 
                 ***[It really does!]
                    ~SmileResponse()
               Oh, you agree? I thought Maybe it's because it helped me through a tougher time in life , I might be biased. I'm glad to know someone shares the sentiment.
             ****[Biased?]
                   ...Yeah ->toughConvo
         ...
         ***[Rock...soothes the soul?]
            ~NeutralResponse()
             Hmm, you disagrew? Maybe it's because it helped me through a tougher time in life , I might be biased. 
              ****[Biased?]
                   ...Yeah ->toughConvo
              ****[Tougher time in life?]
                   ...Yeah ->toughConvo
     **[Rock is not really my thing]
         ...
         ***[I don't really get it]
                ~NeutralResponse()
             Hmm, you disagree? Maybe it's because it helped me through a tougher time in life , I might be biased. 
               ****[Biased?]
                   ...Yeah ->toughConvo
              ****[Tougher time in life?]
                   ..Yeah ->toughConvo
 ...
 *[Well I'm not the only one fighting am I?]
   ~NegativeResponse() 
     ...
     **[Maybe I just wan't to fight to fight]
         ...
         ****[ Well, your reaction is a major redflag so...]
             ~Death()
         ...
         ****[Was I wrong?]
          ...
          ****[Turns out I don't like nonbinary people]
              ~NegativeResponse() 
                ...
                *****[Yes]
                     ~Death()
                     Have you have really been fucking with me all this time? Did you ever care or was this all just som experiment to you? Get out. ->END
                *****[No]
                       ~Death()
 ...
 *[It's very entertaining]
     ...
     **[Maybe I just wan't to fight to fight]
         ...
         ***[You keep calling my stupid one way or another!]
                     ~AnnoyedResponse() 
         Maybe Bbcause you act like it? You say you mess with my stuff, and after I explain how important it is to me, you tell me the only reason you did it was cause my reaction would be funny? 
...
==toughConvo==
I only just moved here in a hurry so unfortunately I dont have a lot of stuff unpack...
*[In a hurry?]
  ~SmileResponse()
  Ah, yeah, I was living at home to save some cash, but my parents made it impossible to live with them because of our conflicting beliefs. ->Parents
*[You're also new to the area?]
  ~SmileResponse()
    Ah, yeah I was living at home to save some cash, but my parents made it impossible to live with them beacue of our conflicting belifes. ->Parents
